...
databaseRouter.get('/export', asyncHandler(async (_req, res) => {
  const snapshot = await getDatabaseSnapshot()
  return res.json(snapshot)
}))

databaseRouter.post('/import', asyncHandler(async (req, res) => {
...
databaseRouter.get('/export/bundle', asyncHandler(async (req, res) => {
...
databaseRouter.post('/import/bundle', bundleUpload.single('bundle'), asyncHandler(async (req, res) => {
  const file = req.file
  if (!file) {
...
databaseRouter.post('/cleanup/uploads', asyncHandler(async (req, res) => {
