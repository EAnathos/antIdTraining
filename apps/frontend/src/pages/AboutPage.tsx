export default function AboutPage() {
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-justify text-slate-700">Fournir un outil simple et interactif pour apprendre à reconnaître les fourmis et leurs caractéristiques.</p>
      ...
      <p className="mt-2 text-justify text-slate-700">
        Merci à Dambal pour son aide dans l'aggrégation de données et la relecture.
      </p>
      <p className="mt-2 text-justify text-slate-700">
